...
class DotaResponseListToCacheMapperImpl @Inject constructor() : HeroListMapper<DotaResponseItem,DotaResponseItemEntity> {

    override fun map(input: List<DotaResponseItem>?): List<DotaResponseItemEntity> {
        return input?.map {
            DotaResponseItemEntity(
                agiGain = it.agiGain,
